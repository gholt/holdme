...
func Test_OrderedUint32sDups_Add_inOrder(t *testing.T) {
	var slice OrderedUint32sDups
...
func Test_OrderedUint32sDups_Add_inReverseOrder(t *testing.T) {
	var slice OrderedUint32sDups
	for v := uint32(9); ; v-- {
		slice = slice.Add(v)
		if v == 0 {
...
func Test_OrderedUint32sDups_Add_inShuffledOrder(t *testing.T) {
	var slice OrderedUint32sDups
	slice = slice.Add(3)
	slice = slice.Add(6)
	slice = slice.Add(4)
...
func Test_OrderedUint32sDups_Add_inShuffledOrderWithDups(t *testing.T) {
	var slice OrderedUint32sDups
	slice = slice.Add(3)
	slice = slice.Add(6)
	slice = slice.Add(4)
...
func Test_OrderedUint32sDups_Remove(t *testing.T) {
	var slice OrderedUint32sDups
	for v := uint32(0); v < 10; v++ {
		slice = slice.Add(v)
	}
...
func Test_OrderedUint32sDups_Remove_hadDups(t *testing.T) {
	var slice OrderedUint32sDups
	for v := uint32(0); v < 10; v++ {
		slice = slice.Add(v)
	}
