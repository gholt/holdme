...
func Test_OrderedNumbersDups_Add_inOrder(t *testing.T) {
	var slice OrderedNumbersDups
...
func Test_OrderedNumbersDups_Add_inReverseOrder(t *testing.T) {
	var slice OrderedNumbersDups
...
func Test_OrderedNumbersDups_Add_inShuffledOrder(t *testing.T) {
	var slice OrderedNumbersDups
	slice = slice.Add(3)
	slice = slice.Add(6)
	slice = slice.Add(4)
...
func Test_OrderedNumbersDups_Add_inShuffledOrderWithDups(t *testing.T) {
	var slice OrderedNumbersDups
	slice = slice.Add(3)
	slice = slice.Add(6)
	slice = slice.Add(4)
...
func Test_OrderedNumbersDups_Remove(t *testing.T) {
	var slice OrderedNumbersDups
	for v := NumericType(0); v < 10; v++ {
		slice = slice.Add(v)
	}
...
func Test_OrderedNumbersDups_Remove_hadDups(t *testing.T) {
	var slice OrderedNumbersDups
	for v := NumericType(0); v < 10; v++ {
		slice = slice.Add(v)
	}
